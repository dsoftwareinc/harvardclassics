...
export interface TextSelectEventDirective {
    text: string;
...
export class TextSelectDirective implements OnInit, OnDestroy {
    ...
    public textSelectEvent: EventEmitter<TextSelectEventDirective>;
    ...
    // emitted as a TextSelectEventDirective within the current element.
